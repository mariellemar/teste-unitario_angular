...
describe('BankingComponent', () => {
  ...
  it (`(U) setSacar(): should transfer from carteira`, () => {
  ...
  it (`
    (U) setSacar() should transfer poupanca don't have string (isNaN)
     or poupanca < value`
     , () => {
  ...
  it (`(U) setDepositar(): should transfer from poupanca`, () => {
  ...
  it (`
  (U) setDepositar() should transfer carteira don't have string (isNaN)
   or carteira < value`
   , () => {
